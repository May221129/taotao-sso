<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page trimDirectiveWhitespaces="true"%><!-- 去除jsp代码编译之后的空白 -->
<%
...
function addToFavorite() {
	...
	<div class="w" id="logo">
		<div>
			<a href="http://www.taotao.com/"> <img
				src="${staticUrl }/images/taotao-logo.gif" alt="京东商城" width="170" height="60" />
			</a> <b></b>
		</div>
	</div>
	...
	<div class="w" id="regist">
		<div class="mt">
			<ul class="tab">
				...
				<li class="line hide"><a
					clstag="regist|keycount|personalreg|02" href="../reg/company">企业用户</a></li>
				<li class="fore hide"><a
					href="http://passport.en.jd.com/user/facade">International
						Customers</a></li>
			</ul>
			<div class="extra">
		...
		<div class="mc">
			<form id="personRegForm" method="post" onsubmit="return false;">
				<input type="hidden" name="regType" id="regType" value="person" /> <input
					type="hidden" name="uuid" id="uuid" value="${uuid}" /> <input
				...
				<div class="form" onselectstart="return false;">
					<div class="item" id="select-regName">
						...
						<div class="fl item-ifo">
							...
							<input type="hidden" value="-1" id="hnschool" class="hide" /> <input
								type="hidden" id="schoolid" name="schoolid" class="hide" /> <input
								type="hidden" name="eBHtwyeixI" value="EyEFt" /> <input
								type="hidden" id="hnseli" class="hide" />
						...
						<div class="item">
							...
							<div class="fl item-ifo">
								<input type="password" id="pwd" name="password" class="text"
									...
									onpaste="return  false" autocomplete="off" /> <i class="i-pass"></i>
								<label id="pwd_succeed" class="blank"></label> <label
									id="pwd_error"></label> <span class="clr"></span> <label
									class="hide" id="pwdstrength"><span class="fl">安全程度：</span><b></b></label>
						...
						<div class="item" id="dphone">
							...
							<div class="fl item-ifo">
								<input type="text" id="phone" maxlength="11" name="phone"
									class="text" tabindex="4" onfocus="phoneFocus();"
									onKeyup="phoneKeyup();" onblur="phoneBlur();"
						...
						<div class="fl item-ifo">
							<input type="checkbox" class="checkbox" checked="checked"
								...
								for="protocol">我已阅读并同意<a href="#" class="blue"
									id="protocol">《京东用户注册协议》</a></label> <span class="clr"></span> <label
	...
	<script type="text/javascript"
		src="${staticUrl }/js/register/jdValidate.regSuccess.js"></script>
